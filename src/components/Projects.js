        ...
        <div>
            ...
            <div className="projects-container__item">
                    <h2 className="secondary-header">
                        RISE
                        <a
                         href="https://github.com/JBlaney93/RiseBudgetFrontEnd" 
                ...
                <div className="projects-container__item">
                    <h2 className="secondary-header">
                        PowerPong League
                        <a
                         href="https://github.com/JBlaney93/PowerPongLeague" 
                        className="github-link">
                            GitHub
                        </a>
                        </h2>
                ...
                <div className="projects-container__item">
                    ...
                    <div className="image-container">
                        <img src={tt_countries_pic} className="image-container__main-image" alt=" "/>
                        <img src={tt_memories_pic} className="image-container__main-image" alt=" "/>
                    </div>
